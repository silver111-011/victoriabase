{{-- resources/views/solutions/mfi.blade.php --}}
@extends('layouts.app')
@section('title', 'Microfinance Institutions — Nile Axis')
...
<div style="min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:120px 5% 80px;background:#f7faff;text-align:center;">
    <div style="max-width:560px;">
        ...
        <h2 style="font-family:'Playfair Display',serif;font-size:36px;color:#1e293b;margin-bottom:14px;">Microfinance Institutions</h2>
        <p style="font-size:16px;color:#64748b;line-height:1.75;margin-bottom:36px;">How Nile Axis powers MFI operations from client registration to regulatory reporting.</p>
