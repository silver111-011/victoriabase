...
@extends('layouts.app')
@section('title', 'What's New — Nile Axis')
@push('styles')
...
<div style="min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:120px 5% 80px;background:#f7faff;text-align:center;">
    <div style="max-width:560px;">
        ...
        <h2 style="font-family:'Playfair Display',serif;font-size:36px;color:#1e293b;margin-bottom:14px;">What's New</h2>
        <p style="font-size:16px;color:#64748b;line-height:1.75;margin-bottom:36px;">Latest features, bug fixes, and improvements to the Nile Axis platform.</p>
