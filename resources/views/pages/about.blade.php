...
@extends('layouts.app')
@section('title', 'About Us — Victoria base')
@push('styles')
...
<div style="min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:120px 5% 80px;background:#f7faff;text-align:center;">
    <div style="max-width:560px;">
        ...
        <div style="font-size:11px;letter-spacing:.1em;text-transform:uppercase;color:#1a6fd4;font-weight:600;margin-bottom:12px;">Victoria base</div>
        <h2 style="font-family:'Playfair Display',serif;font-size:36px;color:#1e293b;margin-bottom:14px;">About Us</h2>
        <p style="font-size:16px;color:#64748b;line-height:1.75;margin-bottom:36px;">Learn about Victoria base, our mission, and the team building Africa's leading microfinance platform.</p>
